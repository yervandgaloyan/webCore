<?php
    setFileName('ui_components/sidebar.php');
?>
<!-- ========== Left Sidebar Start ========== -->
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="index.html" class="waves-effect">
                        <i class="ri-home-gear-line"></i><span class="badge rounded-pill bg-success float-end">3</span>
                        <span>Dashboard</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="apps-chat.html" class=" waves-effect">
                        <i class="ri-chat-1-line"></i><span class="badge rounded-pill bg-warning float-end">New</span>
                        <span>Chat</span>
                    </a>
                </li>
